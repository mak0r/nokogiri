...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_memory_leak.rb", "test/test_reader.rb", "test/test_convert_xpath.rb", "test/test_css_cache.rb", "test/html/test_node.rb", "test/html/test_document.rb", "test/html/sax/test_parser_context.rb", "test/html/sax/test_parser.rb", "test/html/test_named_characters.rb", "test/html/test_node_encoding.rb", "test/html/test_document_encoding.rb", "test/html/test_document_fragment.rb", "test/html/test_element_description.rb", "test/html/test_builder.rb", "test/test_xslt_transforms.rb", "test/css/test_nthiness.rb", "test/css/test_xpath_visitor.rb", "test/css/test_parser.rb", "test/css/test_tokenizer.rb", "test/xml/test_node.rb", "test/xml/test_node_set.rb", "test/xml/node/test_save_options.rb", "test/xml/node/test_subclass.rb", "test/xml/test_node_attributes.rb", "test/xml/test_comment.rb", "test/xml/test_text.rb", "test/xml/test_document.rb", "test/xml/test_c14n.rb", "test/xml/sax/test_parser_context.rb", "test/xml/sax/test_push_parser.rb", "test/xml/sax/test_parser.rb", "test/xml/test_relax_ng.rb", "test/xml/test_xpath.rb", "test/xml/test_node_inheritance.rb", "test/xml/test_unparented_node.rb", "test/xml/test_dtd_encoding.rb", "test/xml/test_syntax_error.rb", "test/xml/test_entity_decl.rb", "test/xml/test_node_encoding.rb", "test/xml/test_attribute_decl.rb", "test/xml/test_document_encoding.rb", "test/xml/test_element_decl.rb", "test/xml/test_parse_options.rb", "test/xml/test_document_fragment.rb", "test/xml/test_namespace.rb", "test/xml/test_node_reparenting.rb", "test/xml/test_reader_encoding.rb", "test/xml/test_processing_instruction.rb", "test/xml/test_builder.rb", "test/xml/test_attr.rb", "test/xml/test_schema.rb", "test/xml/test_cdata.rb", "test/xml/test_entity_reference.rb", "test/xml/test_xinclude.rb", "test/xml/test_dtd.rb", "test/xml/test_element_content.rb", "test/decorators/test_slop.rb", "test/xslt/test_exception_handling.rb", "test/xslt/test_custom_functions.rb", "test/test_soap4r_sax.rb", "test/test_encoding_handler.rb", "test/test_nokogiri.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<hoe-debugging>, ["= 1.0.1"])
      ...
      s.add_dependency(%q<hoe-debugging>, ["= 1.0.1"])
